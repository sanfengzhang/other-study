...
package com.escaf.flume.sink;

import static com.escaf.flume.sink.KafkaSinkConstants.BATCH_SIZE;
import static com.escaf.flume.sink.KafkaSinkConstants.BOOTSTRAP_SERVERS_CONFIG;
import static com.escaf.flume.sink.KafkaSinkConstants.BROKER_LIST_FLUME_KEY;
import static com.escaf.flume.sink.KafkaSinkConstants.DEFAULT_ACKS;
import static com.escaf.flume.sink.KafkaSinkConstants.DEFAULT_BATCH_SIZE;
import static com.escaf.flume.sink.KafkaSinkConstants.DEFAULT_KEY_SERIALIZER;
import static com.escaf.flume.sink.KafkaSinkConstants.DEFAULT_TOPIC;
import static com.escaf.flume.sink.KafkaSinkConstants.DEFAULT_VALUE_SERIAIZER;
import static com.escaf.flume.sink.KafkaSinkConstants.KAFKA_PRODUCER_PREFIX;
import static com.escaf.flume.sink.KafkaSinkConstants.KEY_HEADER;
import static com.escaf.flume.sink.KafkaSinkConstants.KEY_SERIALIZER_KEY;
import static com.escaf.flume.sink.KafkaSinkConstants.MESSAGE_SERIALIZER_KEY;
import static com.escaf.flume.sink.KafkaSinkConstants.OLD_BATCH_SIZE;
import static com.escaf.flume.sink.KafkaSinkConstants.REQUIRED_ACKS_FLUME_KEY;
import static com.escaf.flume.sink.KafkaSinkConstants.TOPIC_CONFIG;
...
public class KafkaSink extends AbstractSink implements Configurable
{
	...
	private boolean enableStringSerializable = true;
			...
			for (; processedEvents < batchSize; processedEvents += 1)
			{
				...
				try
				{
					if (enableStringSerializable)
					{
						...
						headerMap.remove(KEY_HEADER);
						// Allow a specified header to override a static ID
						if (partitionHeader != null)
						{
							String headerVal = headerMap.get(partitionHeader);
							if (headerVal != null)
							{
						...
						if (partitionId != null)
						{
							record = new ProducerRecord<String, String>(eventTopic, partitionId, eventKey,
									JSON.toString(headerMap));
						} else
						{
							record = new ProducerRecord<String, String>(eventTopic, eventKey, JSON.toString(headerMap));
						}
					} else
					{
	...
	public void configure(Context context)
	{
		...
		enableStringSerializable = context.getBoolean(KafkaSinkConstants.ESCAF_KAFKA_SERIALIZABLE_ENABLE, true);
